...
```{r, echo=FALSE, out.width="100%", fig.cap="Die Kaltzeiten und nachweisbare vergletscherungen in Norddeutschland (Quelle: Stephan 2014: 6"}
...
```{r, echo=FALSE, out.width="100%", fig.cap="Maximaler Vorstoß der Gletscher in der Saale-Kaltzeit (Quelle: Böse et al. 2018: 77"}
knitr::include_graphics("images/Christian vorsortiert/Estliches Hegelland/Saale-vereisung.jpg")
```


```{r, echo=FALSE, out.width="100%", fig.cap="Maximaler Vorstoß der Gletscher in der Weichsel-Kaltzeit (Quelle: Ehlers 2020: 50"}
