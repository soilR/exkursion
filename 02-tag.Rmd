# Montag, 14.09.2021 - Moorgenese - Trinkwassergewinnung
<div style="text-align: justify">

Nach einem entspannten Abend in der [Wiehnen-Therme](https://www.wiehen-therme.com/) sind wir alle gestärkt und motiviert aufgebrochen. Das Hotel bot am Morgen für fast alle in der Runde eine schöne Aussicht. Manche durften leider nur die gegenüberliegende Hauswand bewundern. Das nächste Ziel des  ersten Tages war das Große Torfmoor in den Bastauwiesen. Die Bastauwiesen durften wir am vorherigen Tag bereits kennenlernen und bei einem Bier die Aussicht auf diese genießen. Im Anschluss an das Moor ging es dann weiter in Richtung des Wasserwerks Geleto.  

```{r, echo=FALSE, fig.cap="Aussicht Wiehnen Therme"}
knitr::include_graphics("images/kristof/IMG_9142.jpg")
```
...
knitr::include_graphics("images/Maren/640px-Bastauwiesen1.png")
```
...
```{r, echo=FALSE, fig.cap="Spaziergang im Moor"}
knitr::include_graphics("images/Jana/20210914_090755.jpg")
```
...
Exkursionsleitung, mündliche Kommunikation, 2021. Vortrag zum Bastauwiesenmoor.
...
![Abb.XY: Bemalter Filter im Wasserwerk Getelo 1](images/Jana/20210914_123811.jpg)

![Abb XX: Bemalter Filter im Wasserwerk Getelo 2](images/Julia/1.jpg)
