...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d165143.25200603396!2d9.51539689719202!3d53.62550222547214!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47b17ccc4c497f93%3A0x374c1274f382dbb4!2sAluminiumoxid-Werke%20Stade%20GmbH!5e0!3m2!1sde!2sde!4v1644840747080!5m2!1sde!2sde" width="800" height="600" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
...
```{r, echo=FALSE, fig.align='center', out.width="100%", fig.cap="Bauxitabbau in Guinea (Quelle: Wirtgen Group 2021)."}
knitr::include_graphics("images/Christian vorsortiert/Stade Aluminiumwerk/w_photo_2500sm_00880_hi_992x558.jpg")
```

```{r, echo=FALSE, fig.align='center', out.width="50%", fig.cap="Güterschiff im Werkseigenen Hafen (Quelle: Aluminium Oxid Stade GmbH 2021)."}
knitr::include_graphics("images/Christian vorsortiert/Stade Aluminiumwerk/hafen_schiff_von_vorne.jpg")
```


```{r, echo=FALSE, fig.align='center', out.width="50%", fig.cap="Löschung der Ladung (Quelle: Aluminium Oxid Stade GmbH 2021)."}
knitr::include_graphics("images/Christian vorsortiert/Stade Aluminiumwerk/hafen_luke.jpg")
```
...
```{r, echo=FALSE, fig.align='center', out.width="50%", fig.cap="Rohraufschlussanlage in welcher Bauxit und Natronlauge vermengt und erhitzt werden (Quelle: Aluminium Oxid Stade GmbH 2021)."}
...
```{r, echo=FALSE, fig.align='center', out.width="50%", fig.cap="Anlage in der das Aluminiumhydroxid in Kristallform ausfällt (Quelle: Aluminium Oxid Stade GmbH 2021)."}
...
```{r, echo=FALSE, fig.align='center', out.width="50%", fig.cap="Filtration der Aluminiumhydroxidkristalle (Quelle: Aluminium Oxid Stade GmbH 2021)."}
...
```{r, echo=FALSE, fig.align='center', out.width="50%", fig.cap="Das fertige Aluminiumhydroxid im Lager (Quelle: Aluminium Oxid Stade GmbH 2021)."}
...
Auf dem Hof ist das Problem, dass zu viel Wasser vorhanden ist. Dies ist aber auch ein Vorteil. Gespeichert wird das Wasser in Teichen. Dort stehen Pumpen, an Leitungen angeschlossen. Es regnet dann überall. Daraufhin entsteht ein Wassereisgemisch. Dieses Gemisch bleibt bei Null Grad stehen, kälter wird es nicht. So lange, bis alles Wasser gefroren ist. Erst wenn das Wasser weg ist und nur noch Eis übrig ist, wird das Eis kälter. Da es aber immer ein Wassereisgemisch bleibt, immer Wasser obendrauf kommt, kann, was zu viel ist, runtertropfen. Dieses Phänomen nennt sich Erstarrungswärme. "Wie Schwitzen nur umgekehrt" (Lühs). Dieser Vorgang ist sehr energiereich.
