...
## Besuch des Herzapfelhofes im Alten Land
...
Wie uns Herr Lühs erzählte, werden auf diesem Hof 90% Äpfel, 5% Süßkirsche und 5% Sonstige (Zwetschgen, Pflaumen, Birnen) angebaut. Außerdem gibt es noch vereinzelte Erdbeerfelder. Auch Quitten werden angebaut, die jedoch in einer Ecke stehen, wo nichts gemacht wird, da der Markt zu klein dafür ist.

Der Apfelhof ist ein Biobetrieb und Mitglied von Demeter. Richtlinie ist die EG-Bio-Verordnung, an die sich alle halten müssen. Diese ist auch international gebenchmarkt. Des Weiteren gibt es die Anbauverbände, die noch striktere Richtlinien haben. Bioland ist der größte Verband hier in Deutschland. Als internationalen Verband gibt es noch Demeter. In der Schweiz gibt es Swissorganic und in Frankreich eigentlich nur Bio aber kein Demeter oder Bio Parks. Bio oder nicht-Bio ist eher ein deutschsprachiges Ding. Für andere Länder ist „fair-trade“ wichtiger.
...
Manchmal machen das auch Mitarbeiter mit Haken. Ist häufig einfacher als Bagger zu bestellen. 
...
In Südtirol kostet der Hektar eine Million Euro, weil auf landwirtschaftliche Einkommen keine Einkommenssteuer gezahlt werden muss. 4 Hektar Äpfel reicht dort schon für schwarze Zahlen. Ist eine Sonderregion, eine Clusterbildung, die aber auch gewünscht ist. 

Obstbetriebe sind meistens kleine Betriebe, verglichen mit Ackerbau. Da braucht man 100, 200, 300 Hektar. Wenn man nur 20 hat, dann müssen ganz viele aufhören. Oder man überlegt sich etwas anderes. Und mit so einer Kultur kann man auf kleinerer Fläche auch geregeltes Einkommen erwirtschaften. Auch mit Gartenbau, gärtnerischen Kulturen, da kann man auch ganz schnell hohe Umsätze erzielen.
...
Hier ist das Problem, dass zu viel Wasser vorhanden ist. Ist aber auch ein Vorteil. In Teichen wird das Wasser gespeichert. Dort stehen Pumpen, an Leitungen angeschlossen. Es regnet dann überall. Und dann entsteht hier ein Wassereisgemisch. Ein Gemisch bleibt bei 0 Grad stehen, kälter wird es nicht. So lange bis alles Wasser gefroren ist. Erst wenn alles Wasser weg ist, also nur noch Eis da ist, dann wird das Eis kälter. Da es aber immer ein Wassereisgemisch bleibt, immer Wasser obendrauf kommt, kann was zu viel ist, runtertropfen. Das Phänomen nennt sich Erstarrungswärme. Wie Schwitzen nur umgekehrt.Dieser Vorgang ist sehr energiereich.
