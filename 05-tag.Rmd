...
```{r, echo=FALSE, fig.align='center', fig.cap="Bauxitabbau in Guinea (Quelle: Wirtgen Group 2021)."}
knitr::include_graphics("images/Christian vorsortiert/Stade Aluminiumwerk/w_photo_2500sm_00880_hi_992x558.jpg")
```

```{r, echo=FALSE, fig.align='center', fig.cap="Güterschiff im Werkseigenen Hafen (Quelle: Aluminium Oxid Stade GmbH 2021)."}
knitr::include_graphics("images/Christian vorsortiert/Stade Aluminiumwerk/hafen_schiff_von_vorne.jpg")
```


```{r, echo=FALSE, fig.align='center', fig.cap="Löschung der Ladung (Quelle: Aluminium Oxid Stade GmbH 2021)."}
...
```{r, echo=FALSE, fig.align='center', fig.cap="Rohraufschlussanlage in welcher Bauxit und Natronlauge vermengt und erhitzt werden (Quelle: Aluminium Oxid Stade GmbH 2021)."}
...
```{r, echo=FALSE, fig.align='center', fig.cap="Anlage in der das Aluminiumhydroxid in Kristallform ausfällt (Quelle: Aluminium Oxid Stade GmbH 2021)."}
...
```{r, echo=FALSE, fig.align='center', fig.cap="Filtration der Aluminiumhydroxidkristalle (Quelle: Aluminium Oxid Stade GmbH 2021)."}
...
```{r, echo=FALSE, fig.align='center', fig.cap="Das fertige Aluminiumhydroxid im Lager (Quelle: Aluminium Oxid Stade GmbH 2021)."}
