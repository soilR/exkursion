...
```{r, echo=FALSE, out.width="100%", fig.cap="Bauxitabbau in Guinea (Quelle: Wirtgen Group 2021)."}
knitr::include_graphics("images/Christian vorsortiert/Stade Aluminiumwerk/w_photo_2500sm_00880_hi_992x558.jpg")
```

```{r, echo=FALSE, out.width="50%", fig.cap="Güterschiff im Werkseigenen Hafen (Quelle: Aluminium Oxid Stade GmbH 2021)."}
knitr::include_graphics("images/Christian vorsortiert/Stade Aluminiumwerk/hafen_schiff_von_vorne.jpg")
```


```{r, echo=FALSE, out.width="50%", fig.cap="Löschung der Ladung (Quelle: Aluminium Oxid Stade GmbH 2021)."}
