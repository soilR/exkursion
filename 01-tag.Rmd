...
```{r, echo=FALSE, fig.align='center', fig.cap="Blick auf die alte Kanalbrücke aus südwestlicher Richtung."}
...
```{r, echo=FALSE, fig.align='center', fig.cap="Blick von der alten Kanalbrücke nach Süden. Links: Weserbergland, Mitte: Porta Westfalica und Weserdurchbruch, Rechts: Wiehengebirge."}
...
```{r, echo=FALSE, fig.align='center', fig.cap="Drei Milchkühe der Rasse Holstein-Friesian im Boxenlaufstall."}
knitr::include_graphics("images/Jana/20210913_134559.jpg")
```

```{r, echo=FALSE, fig.align='center', fig.cap="Führung über den Bauernhof durch Herrn Kinkelbur."}
...
```{r, echo=FALSE, fig.align='center', fig.cap="Beschilderung für die BesucherInnen des Hofes."}
knitr::include_graphics("images/Julia/IMG_20210913_150255.jpg")
```

```{r, echo=FALSE, fig.align='center', fig.cap="Der neue Hofladen."}
...
```{r, echo=FALSE, fig.align='center', fig.cap="Gesteinsaufschluss am Oberlübber Bergsee."}
...
```{r, echo=FALSE, fig.align='center', fig.cap="Durch den Rapserdfloh beschädigter Rapskeimling."}
...
```{r, echo=FALSE, fig.align='center', fig.cap="Mittels Pürckhauer entnommene Bodenprobe: Kolluvisol."}
