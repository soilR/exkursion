...
<iframe src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d19543.18938125817!2d8.8951862!3d52.2452241!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sde!2sde!4v1644837537937!5m2!1sde!2sde" width="800" height="600" style="border:0;" allowfullscreen="" loading="lazy"></iframe>

Unsere Exkursion startete am Montag den 13. September 2021 gegen 08:00 am [Rundbau des Geographischen Instituts]( https://geographie.uni-koeln.de/institut/gebaeude/rundbau) der Universität zu Köln. Nachdem wir den gemieteten Van mit unseren zahlreichen Taschen, Rucksäcken und allerlei technischem Equipment beladen hatten, ging die Reise in Richtung Norddeutschland los.
...
```{r, echo=FALSE, out.width="50%", fig.align='center', fig.cap="Kaiser-Wilhelm Denkmal an der Porta Westfalica."}
...
<iframe src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d4879.3817329621925!2d8.9314611!3d52.3034651!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sde!2sde!4v1644837637613!5m2!1sde!2sde" width="800" height="600" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
...
```{r, echo=FALSE, out.width="50%", fig.align='center', fig.cap="Blick auf die alte Kanalbrücke aus südwestlicher Richtung."}
...
```{r, echo=FALSE, fig.align='center', out.width="100%", fig.cap="Blick von der alten Kanalbrücke nach Süden. Links: Weserbergland, Mitte: Porta Westfalica und Weserdurchbruch, Rechts: Wiehengebirge."}
...
<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d78114.8275310943!2d8.763658!3d52.2780978!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47ba7367b7758f5b%3A0xcf9bbe3bfef8111c!2sFriedrich%20Kinkelbur%20Biohof!5e0!3m2!1sde!2sde!4v1644837193247!5m2!1sde!2sde" width="800" height="600" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
...
```{r, echo=FALSE, fig.align='center', out.width="100%", fig.cap="Drei Milchkühe der Rasse Holstein-Friesian im Boxenlaufstall."}
knitr::include_graphics("images/Jana/20210913_134559.jpg")
```

```{r, echo=FALSE, fig.align='center', out.width="100%", fig.cap="Führung über den Bauernhof durch Herrn Kinkelbur."}
...
```{r, echo=FALSE, fig.align='center', out.width="50%", fig.cap="Beschilderung für die BesucherInnen des Hofes."}
knitr::include_graphics("images/Julia/IMG_20210913_150255.jpg")
```

```{r, echo=FALSE, fig.align='center', out.width="100%", fig.cap="Der neue Hofladen."}
...
<iframe src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d2440.694810105093!2d8.7277731!3d52.2852424!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sde!2sde!4v1644837658458!5m2!1sde!2sde" width="800" height="600" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
...
```{r, echo=FALSE, fig.align='center', out.width="100%", fig.cap="Gesteinsaufschluss am Oberlübber Bergsee."}
