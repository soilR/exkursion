...
```{r, echo=FALSE, fig.align='center', fig.cap="Elbfähre Wischhafen - Glückstadt."}
...
```{r, echo=FALSE, fig.align='center', fig.cap="Blick auf ein Containerschiff. Im Vordergrund sind unterschiedliche an der Elbe heimische sowie Zugvögel zu erkennen."}
...
```{r, echo=FALSE, fig.align='center', fig.cap="Ausblick vom Aussichtspunkt Lägerdorf auf die Lägerdorfer Kreidegruben. Von links nach rechts: Grube Schinkel, Grube Alsen und Grube Heidestraße."}
...
```{r, echo=FALSE, fig.align='center', fig.cap="Wegweiser am Aussichtspunkt Lägerdorf."}
...
```{r, echo=FALSE, fig.align='center', fig.cap="St. Johannis-Kirche in Meldorf und Meldorfer Marktplatz."}
...
```{r, echo=FALSE, fig.align='center', fig.cap="Gute Laune trotz anstrengender Arbeit und kleinen Regenschauern."}
...
```{r, echo=FALSE, fig.align='center', fig.cap="Aufgegrabenes Bodenprofil: Norm-Kalkmarsch."}
