...
```{r, echo=FALSE, fig.align='center', fig.cap="Das Klimahaus in Bremerhaven links im Bild (außenansicht)."}
...
```{r, echo=FALSE, fig.align='center', fig.cap="Fischotter im Zoo von Bremerhaven."}
knitr::include_graphics("images/kristof/IMG_9234.jpg")
```

```{r, echo=FALSE, fig.align='center', fig.cap="Eisbär im Zoo von Bremerhaven."}
...
```{r, echo=FALSE, fig.align='center', fig.cap="Deutsches Auswandererhause Bremerhaven (Quelle: Bremen.de 2021)."}
...
```{r, echo=FALSE, fig.align='center', fig.cap="Nachbau des Eingangs eines Passagierschiffes im Bremer Auswandererhaus (Quelle: Bremen.de 2021)."}
...
```{r, echo=FALSE, fig.align='center', fig.cap="Archiv von Logbucheinträgen und Tagebuchseiten ehemaliger Passagiere (Quelle: Andreas Heller 2021)."}
...
```{r, echo=FALSE, fig.align='center', fig.cap="Die Gruppe in der Innenstadt."}
...
```{r, echo=FALSE, fig.align='center', fig.cap="Typische Bremer dreigeteilte Häuser."}
knitr::include_graphics("images/Jana/20210916_175454.jpg")
```

```{r, echo=FALSE, fig.align='center', fig.cap="Bremer Häuser in einer wohlhabenderen Straße."}
...
```{r, echo=FALSE, fig.align='center', fig.cap="Bratkartoffeln mit Knips."}
knitr::include_graphics("images/kristof/IMG_20210916_194356.jpg")
```

```{r, echo=FALSE, fig.align='center', fig.cap="Bremer Labskaus."}
