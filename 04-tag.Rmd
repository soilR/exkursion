...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d21912.085655367606!2d8.571078012585401!3d53.545019107658064!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47b6b1190edc39d7%3A0xe72b33d302c79ded!2sKlimahaus%20Bremerhaven!5e0!3m2!1sde!2sde!4v1644840413410!5m2!1sde!2sde" width="800" height="600" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
...
```{r, echo=FALSE, fig.align='center', out.width="100%", fig.cap="Das Klimahaus in Bremerhaven links im Bild (außenansicht)."}
...
```{r, echo=FALSE, fig.align='center',out.width="100%", fig.cap="Fischotter im Zoo von Bremerhaven."}
knitr::include_graphics("images/kristof/IMG_9234.jpg")
```

```{r, echo=FALSE, fig.align='center', out.width="100%", fig.cap="Eisbär im Zoo von Bremerhaven."}
...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14625.453486848442!2d8.568298834474227!3d53.542441236007114!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47b6b11c74c0402f%3A0xc9222ce40decbae2!2sDeutsches%20Auswandererhaus!5e0!3m2!1sde!2sde!4v1644840579827!5m2!1sde!2sde" width="800" height="600" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
...
```{r, echo=FALSE, fig.align='center', out.width="100%", fig.cap="Deutsches Auswandererhause Bremerhaven (Quelle: Bremen.de 2021)."}
...
Meist von sozialer Not getrieben, bestiegen hier von 1830 an 7,2 Millionen Menschen die Passagierschiffe der eigens darauf spezialisierten Reedereien, welche sie über den Atlantik tragen sollten.
...
```{r, echo=FALSE, fig.align='center', out.width="100%", fig.cap="Nachbau des Eingangs eines Passagierschiffes im Bremer Auswandererhaus (Quelle: Bremen.de 2021)."}
...
```{r, echo=FALSE, fig.align='center', out.width="100%", fig.cap="Archiv von Logbucheinträgen und Tagebuchseiten ehemaliger Passagiere (Quelle: Andreas Heller 2021)."}
...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d13173.658843168147!2d8.812103882561534!3d53.073646639208356!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47b127fd07282035%3A0x895482417caab07a!2sSteintor%2C%2028203%20Bremen!5e0!3m2!1sde!2sde!4v1644840691958!5m2!1sde!2sde" width="800" height="600" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
...
```{r, echo=FALSE, fig.align='center', out.width="100%", fig.cap="Die Gruppe in der Innenstadt."}
...
```{r, echo=FALSE, fig.align='center', out.width="100%", fig.cap="Typische Bremer dreigeteilte Häuser."}
knitr::include_graphics("images/Jana/20210916_175454.jpg")
```

```{r, echo=FALSE, fig.align='center',out.width="100%", fig.cap="Bremer Häuser in einer wohlhabenderen Straße."}
...
```{r, echo=FALSE, fig.align='center', out.width="100%", fig.cap="Bratkartoffeln mit Knips."}
knitr::include_graphics("images/kristof/IMG_20210916_194356.jpg")
```

```{r, echo=FALSE, fig.align='center', out.width="100%", fig.cap="Bremer Labskaus."}
