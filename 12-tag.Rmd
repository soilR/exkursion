...
```{r, echo=FALSE, out.width="60%", fig.cap="Arendsee"}
...
„Wenn man Salz in einen Kochtopf gibt, verkocht es, und am Ende bleibt eine Salzkruste die dann wieder verdampft und die Salze bleiben übrig." Ähnlich ist es beim Zechsteinmeer gewesen. Zuerst gibt es einen Zustrom, wenn der globale Meeresspiegel aber sinkt, kann dieser Zufluss auch unterbrochen werden. Ein abgeschlossenes Becken entsteht, ähnlich wie die Ostsee und das Mittelmeer. Auch an der Straße von Gibraltar war es einmal geschlossen, sodass das Mittelmeer keinen Zufluss zum Atlantik hatte und wie eine "überdimensionale Pfütze" gewesen ist. 
...
Als nächstes würden Sulfat Verbindungen in der Salinen-Serie ausfallen, z.B. Gips. Das ist die wasserreiche Variante. Zudem Anhydrit, die wasserfreie Variante. Aus diesem Grund hat man Tone, Karbonate und dann die Sulfate. Als letztes würden sich die Edelsalze bilden (z.B. Steinsalz, Natriumchlorid, Kochsalz, oder Kaliumchlorid). Somit findet man in Norddeutschland bis zu 2.000 Meter mächtige Zechsteinabfolgen von Salzen. 
