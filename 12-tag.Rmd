...
```{r, echo=FALSE, fig.align='center', out.width="100%", fig.cap="Mehrere alte Eichen des ehemaligen Hudewalds."}
...
```{r, echo=FALSE, fig.align='center', out.width="100%", fig.cap="Der Baumkronenpfad von oben betrachtet."}
knitr::include_graphics("images/Julia/IMG_20210924_114524.jpg")
```

```{r, echo=FALSE, fig.align='center', out.width="100%", fig.cap="Ausblick auf den Ivenacker See."}
...
```{r, echo=FALSE, fig.align='center', out.width="70%", fig.cap="Arendsee."}
knitr::include_graphics("images/Flow/IMG_7062.jpg")
```

Entstanden ist der See durch das Schmelzen der Gletscher, sodass das Zechsteinmeer vordringen konnte. Durch Flutung wird dieses „Becken“ abgeschnitten oder es kommt durch eine Regression wieder. Beim Rückzug des Wassers bleibt schließlich ein See in diesem Becken übrig. 

Die Entstehung des Zechsteinmeeres ist in einfachen Bildern mit einem Kochtopf zu vergleichen, in dem gesalzenes Wasser verkocht. Zuerst gibt es einen Zustrom, wenn der globale Meeresspiegel aber sinkt, kann dieser Zufluss auch unterbrochen werden. Ein abgeschlossenes Becken entsteht, ähnlich wie die Ostsee und das Mittelmeer. Auch an der Straße von Gibraltar war es einmal geschlossen, sodass das Mittelmeer keinen Zufluss zum Atlantik hatte und wie eine "überdimensionale Pfütze" gewesen ist. 
...
Wenn die Sedimentationsgeschwindigkeit abgesetzt wird, bilden sich feinkörnige Tone. Ganz feinkörnige Sedimentsteine, Tonsteine. Als nächstes fallen die Carbonate aus, also Calciumcarbonat oder Dolomit. Dolomit ist ein Magnesium Karbonat und sehr schlecht wasserlöslich (14 Milligramm pro Liter). Als nächstes würden Sulfat Verbindungen in der Salinen-Serie ausfallen, z.B. Gips. Das ist die wasserreiche Variante. Zudem Anhydrit, die wasserfreie Variante. Aus diesem Grund hat man Tone, Karbonate und dann die Sulfate. Als letztes würden sich die Edelsalze bilden (z.B. Steinsalz, Natriumchlorid, Kochsalz, oder Kaliumchlorid). Somit findet man in Norddeutschland bis zu 2.000 Meter mächtige Zechsteinabfolgen von Salzen. 
...
Das Zechstein ging circa 7 Millionen Jahre, eine sehr prägende und intensive Zeit, vor rund 257 bis 251 Millionen Jahren.
