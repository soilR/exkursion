...
```{r, echo=FALSE, fig.align='center', out.width="80%", fig.cap="Friedrichstadt – oder auch Klein-Amsterdam."}
...
```{r, echo=FALSE, fig.align='center', out.width="70%", fig.cap="Grachten in Friedrichstadt."}
...
```{r, echo=FALSE, fig.align='center', out.width="60%", fig.cap="Wattenmeer."}
...
```{r, echo=FALSE, out.width="40%", fig.cap="J-Röhre des Wattwurms (Quelle: Kock, K., 1998)."}
...
```{r, echo=FALSE, out.width="40%", fig.cap="Salzwiese (Quelle: Common Wadden Sea Secreteriat)."}
