# Sonntag, 19.09.2021 - Kleve, Eidersperrwerk, Friedrichstadt, Wattwanderung

Am siebten Tag konnten wir etwas länger schlafen, da uns der Sonntagvormittag zur freien Gestaltung überlassen wurde. Für den Großteil ging es zum Waschsalon, um die überstrapazierten Kleidungsstücke einmal gründlich zu reinigen. Am Nachmittag folgte zuerst der Besuch von Kleve, bevor es zum Eidersperrwerk und nach Friedrichstadt ging. Am späten Nachmittag folgte schließlich die Wattwanderung bei Sonnenuntergang.
...
<div style="text-align: justify">
Am siebten Tag unserer Exkursion ging es zuerst nach Kleve wo wir an einem Reiterhof haltmachten. Der Ort hat seinen Namen vom Wort „Kliff“ und ist eine ehemalige Steilküste, die aus der Endmoräne der Saale-Eiszeit hervorgeht. Sie setzt sich aus Warthestadiummaterial zusammen. Der Meeresspiegel war deutlich niedriger, es gab mehrere Transgressionen, Niederungen erstrecken sich entlang der Flüsse der Eider. Die Nährungen werden auch als „Donn“ bezeichnet. Donn liegen an einem Näherungsharken.
...
```{r, echo=FALSE, out.width="40%", fig.cap="Friedrichstadt – oder auch Klein-Amsterdam"}
...
```{r, echo=FALSE, out.width="40%", fig.cap="Wattenmeer"}
...
![J-Röhre des Wattwurm](images/Flow/Bildschirmfoto 2021-07-02 um 14.22.46.png)
