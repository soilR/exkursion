...
```{r, echo=FALSE, fig.align='center', fig.cap="Friedrichstadt – oder auch Klein-Amsterdam."}
...
```{r, echo=FALSE, fig.align='center', fig.cap="Grachten in Friedrichstadt."}
...
```{r, echo=FALSE, fig.align='center', fig.cap="Wattenmeer."}
...
```{r, echo=FALSE, fig.cap="J-Röhre des Wattwurms (Quelle: Kock, K., 1998)."}
...
```{r, echo=FALSE, fig.cap="Salzwiese (Quelle: Common Wadden Sea Secreteriat)."}
...
Nach der rund neunzig minütigen Wanderung ging es zurück zum Auto. Anschließend fuhren wir zurück zu unserer Unterkunft. Dort angekommen, spielten wir zu fünft eine spannende Partie Straßenschach bis in die frühen Morgenstunden. 
...
- Kock, K., 1998. Das Watt – Lebensraum auf den zweiten Blick. 7. Auflage. Verlagsdruckerei Boyen & Co. Heide.
